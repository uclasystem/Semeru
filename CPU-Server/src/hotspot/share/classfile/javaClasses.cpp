...
oop java_lang_Class::protection_domain(oop java_class) {
  ...
  //mhr: debug
  // if((unsigned long long)java_class == 0xbaadbabebaadbabeULL) {
  //   printf("error java class!\n");
  // }
  // oop re = java_class->obj_field(_protection_domain_offset);
  // if((unsigned long long)re == 0xbaadbabebaadbabeULL) {
  //   printf("error java class!\n");
  // }
