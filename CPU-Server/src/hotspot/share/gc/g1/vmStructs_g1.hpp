...
#define VM_STRUCTS_G1GC(nonstatic_field,                                      \
  ...
  static_field(HeapRegion, LogOfHRGrainBytes, int)                            \
                                                                              \
  /* nonstatic_field(HeapRegion, region_type(),          HeapRegionType)    */            \
  nonstatic_field(CPUToMemoryAtGC, _type,          HeapRegionType)            \
                                                                              \
  nonstatic_field(HeapRegionType, _tag,       HeapRegionType::Tag volatile)   \
                                                                              \
 /* nonstatic_field(G1ContiguousSpace, _top,              HeapWord* volatile) */  \
  nonstatic_field(SyncBetweenMemoryAndCPU, _top,  HeapWord* volatile)         \
                                                                              \
...
#define VM_TYPES_G1GC(declare_type,                                           \
  ...
  /* Semeru start */                  \
  declare_toplevel_type(CPUToMemoryAtGC)                                 \
  declare_toplevel_type(SyncBetweenMemoryAndCPU)                                 \
  /* Semeru end */                  \
