...
// Used during the Scan RS phase to scan cards from the remembered set during garbage collection.
// mhr: modify
class G1ScanObjsDuringScanRSClosureOptional : public G1ScanClosureBase {
public:
  G1ScanObjsDuringScanRSClosureOptional(G1CollectedHeap* g1h,
                                G1ParScanThreadState* par_scan_state):
    G1ScanClosureBase(g1h, par_scan_state) { }
...
//mhr: modify
//mhr: new
class G1ScanObjsDuringUpdateRSClosureNew : public G1ScanObjsDuringUpdateRSClosure {
public:
  G1ScanObjsDuringUpdateRSClosureNew(G1CollectedHeap* g1h,
                                  G1ParScanThreadState* pss) :
    G1ScanObjsDuringUpdateRSClosure(g1h, pss) { }
...
//mhr: modify
//mhr: new
class G1ScanObjsDuringScanRSClosureNew : public G1ScanClosureBase {
public:
  G1ScanObjsDuringScanRSClosureNew(G1CollectedHeap* g1h,
                                G1ParScanThreadState* par_scan_state):
    G1ScanClosureBase(g1h, par_scan_state) { }
...
//mhr: modify
class G1ScanRSForOptionalClosureNew : public OopClosure {
  G1ScanObjsDuringScanRSClosureOptional* _scan_cl;
public:
  G1ScanRSForOptionalClosureNew(G1ScanObjsDuringScanRSClosureOptional* cl) : _scan_cl(cl) { }
...
//mhr: modify
//mhr: new
class G1ConcurrentRefineOopClosureNew: public BasicOopIterateClosure {
  G1CollectedHeap* _g1h;
  uint _worker_i;

public:
  G1ConcurrentRefineOopClosureNew(G1CollectedHeap* g1h, uint worker_i) :
    _g1h(g1h),
    _worker_i(worker_i) {
  }
