...
public:
  ...
  //mhr: modify
  void scan_rem_set_source(G1ParScanThreadState* pss, uint worker_i);
...
protected:
  ...
  //mhr: new
  //mhr: modify
  virtual void scan_rem_set_roots(HeapRegion* r);
...
// mhr: modify
// mhr: new
class G1Organize : public HeapRegionClosure {
...
public:
  ...
  virtual bool do_heap_region(HeapRegion* r) {
    //r->cross_region_ref_update_queue()->organize();
    return false;
  }
};
...
// mhr: modify
// mhr: new
class G1ScanRSForRegionClosureNew : public G1ScanRSForRegionClosure {
  // G1CollectedHeap* _g1h;
  // G1CardTable *_ct;
  ...
  //void scan_strong_code_roots(HeapRegion* r);
public:
  G1ScanRSForRegionClosureNew(G1RemSetScanState* scan_state,
                           G1ScanObjsDuringScanRSClosure* scan_obj_on_card,
                           G1ParScanThreadState* pss,
                           G1GCPhaseTimes::GCParPhases phase,
                           uint worker_i):G1ScanRSForRegionClosure(scan_state, scan_obj_on_card, pss, phase, worker_i) {};
...
//mhr: modify
//mhr: new add modify
class G1ScanRSForRegionClosureUpdate : public HeapRegionClosure {
  G1CollectedHeap* _g1h;
  G1CardTable *_ct;
  ...
  //mhr: modify
  //mhr: new
  G1ScanObjsDuringScanRSClosureNew* _scan_objs_on_card_cl;
  ...
  bool claim_card_new(size_t card_index, const uint region_idx_for_card);
  void claim_card(size_t card_index, const uint region_idx_for_card);
  void scan_card(MemRegion mr, uint region_idx_for_card);
...
public:
  //mhr: modify
  //mhr: new
  G1ScanRSForRegionClosureUpdate(G1RemSetScanState* scan_state,
...
//mhr: modify
//mhr: new add modify
class G1ScanRSForRegionClosureMemUpdate : public HeapRegionClosure {
  G1CollectedHeap* _g1h;
  G1ParScanThreadState* _pss;
...
public:
  //mhr: modify
  //mhr: new
  G1ScanRSForRegionClosureMemUpdate(G1RemSetScanState* scan_state,
                           G1ParScanThreadState* pss,
                           uint worker_i);
