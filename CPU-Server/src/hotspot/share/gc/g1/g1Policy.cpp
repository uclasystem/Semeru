...
G1Policy::G1Policy(G1CollectorPolicy* policy, STWGCTimer* gc_timer) :
  ...
  _max_cserver_cset_length(0), //mhr: modify
...
//mhr: modify
uint G1Policy::calc_max_cserver_cset_length() {
  //parameter needs to be defined in the global file
  //CPU mem size
  //mhr: TODO
  // if(_max_cserver_cset_length == 0) {
  //   long long cserver_mem_size_bytes = 8 * 1024 * 1024;
  //   cserver_mem_size_bytes *= 1024;
  //   _max_cserver_cset_length = (size_t) (cserver_mem_size_bytes / HeapRegion::GrainBytes);
  // }

  // return _max_cserver_cset_length;
