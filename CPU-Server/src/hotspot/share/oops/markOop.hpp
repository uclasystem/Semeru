...
class markOopDesc: public oopDesc {
 ...
 public:
  ...
  enum { lock_shift               = 0,
         ...
         //mhr: modify
         //,is_target_shift          = hash_shift + hash_bits
  };
  ...
  enum { lock_mask                = right_n_bits(lock_bits),
        ...
        //mhr: modify
        // ,
        // is_target_mask            = right_n_bits(is_target_bits),
        // is_target_mask_in_place        = is_target_mask << is_target_shift
  };
  ...
  //mhr: modify
  // uint    is_in_target_object_queue() {return mask_bits(value() >> is_target_shift, is_target_mask);}
  // markOop set_in_target_object_queue (bool v) const {
  //   return markOop((value() & ~is_target_mask_in_place) | (((uintptr_t)v & is_target_mask) << is_target_shift));
  // }
  // markOop reverse_in_target_object_queue () const {
  //   return markOop((value() ^ is_target_mask_in_place));
  // }
