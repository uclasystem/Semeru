 ...
 * Used as a intermediate structure.
 * One kinds of ioctl command . 
 *  	Copy some information to user space. 
 * 		i.e. Used by partitioning tools, fdisk.
 * 
 * CHS ifnormation (Cylinder, Heads, Sectors)
 * heads 		:
 * sectors 	:
 * cylinders	: 
 * start		: usually from 0 ?
 * 
 * url : https://en.wikipedia.org/wiki/Cylinder-head-sector
 * 
 * 
 * [?] As a memory pool, how to initialize these HDD information ? 
 * 
 */
struct hd_geometry {
      unsigned char heads;
