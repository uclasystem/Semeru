...
/* .. and these are ours ... */
#define _PAGE_DIRTY	0x20000          // [?] Page is 4K, only the low 12 bits can be used as flag ??
...
#define pte_pfn(pte)	(pte_val(pte) >> 32)  // the low 32 bits of pte are used as flags ??
...
extern inline int pte_dirty(pte_t pte)		{ return pte_val(pte) & _PAGE_DIRTY; }    // to test the pte dirty bit .
