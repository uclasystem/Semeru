...
#ifndef SHARE_VM_GC_G1_SEMERU_G1REMSETTRACKINGPOLICY_HPP
#define SHARE_VM_GC_G1_SEMERU_G1REMSETTRACKINGPOLICY_HPP
...
// set is complete.
class G1SemeruRemSetTrackingPolicy : public CHeapObj<mtGC> {
public:
  ...
  bool needs_scan_for_rebuild(SemeruHeapRegion* r) const;
  ...
  void update_at_allocate(SemeruHeapRegion* r);
  ...
  bool update_humongous_before_rebuild(SemeruHeapRegion* r, bool is_live);
