...
#ifndef SHARE_VM_GC_G1_G1SemeruCollectedHeap_INLINE_HPP
...
inline void
G1SemeruCollectedHeap::dirty_young_block(HeapWord* start, size_t word_size) {
...
// inline RefToScanQueue* G1SemeruCollectedHeap::task_queue(uint i) const {
...
inline bool G1SemeruCollectedHeap::is_in_cset(HeapWord* addr) {
...
bool G1SemeruCollectedHeap::is_in_cset_or_humongous(const oop obj) {
...
// inline bool
// G1SemeruCollectedHeap::evacuation_failure_alot_for_gc_type(bool for_young_gc,
...
// inline void
// G1SemeruCollectedHeap::set_evacuation_failure_alot_for_current_gc() {
...
// inline bool G1SemeruCollectedHeap::evacuation_should_fail() {
...
// inline void G1SemeruCollectedHeap::reset_evacuation_should_fail() {
//   if (G1EvacuationFailureALot) {
...
// inline bool G1SemeruCollectedHeap::is_in_young(const oop obj) {
//   if (obj == NULL) {
//     return false;
//   }
