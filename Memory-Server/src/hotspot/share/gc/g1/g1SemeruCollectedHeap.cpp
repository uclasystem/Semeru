...
// // INVARIANTS/NOTES
// //
// // All allocation activity covered by the G1SemeruCollectedHeap interface is
...
// class SemeruRedirtyLoggedCardTableEntryClosure : public CardTableEntryClosure {
//  private:
// 	size_t _num_dirtied;
...
//  public:
// 	SemeruRedirtyLoggedCardTableEntryClosure(G1SemeruCollectedHeap* g1h) : CardTableEntryClosure(),
...
//  */
// HeapWord*
// G1SemeruCollectedHeap::humongous_obj_allocate_initialize_regions(uint first,
// 																													 uint num_regions,
// 																													 size_t word_size) {
...
// HeapWord* G1SemeruCollectedHeap::humongous_obj_allocate(size_t word_size) {
...
HeapWord* G1SemeruCollectedHeap::allocate_new_tlab(size_t min_size,
...
HeapWord* G1SemeruCollectedHeap::mem_allocate(size_t word_size,
...
HeapWord* G1SemeruCollectedHeap::attempt_allocation_slow(size_t word_size) {
...
// void G1SemeruCollectedHeap::begin_archive_alloc_range(bool open) {
...
// bool G1SemeruCollectedHeap::is_archive_alloc_too_large(size_t word_size) {
...
// void G1SemeruCollectedHeap::end_archive_alloc_range(GrowableArray<MemRegion>* ranges,
...
// bool G1SemeruCollectedHeap::check_archive_addresses(MemRegion* ranges, size_t count) {
...
// bool G1SemeruCollectedHeap::alloc_archive_regions(MemRegion* ranges,
// 																						size_t count,
// 																						bool open) {
...
// void G1SemeruCollectedHeap::fill_archive_regions(MemRegion* ranges, size_t count) {
// 	assert(!is_init_completed(), "Expect to be called at JVM init time");
// 	assert(ranges != NULL, "MemRegion array NULL");
// 	assert(count != 0, "No MemRegions provided");
// 	MemRegion reserved = _hrm->reserved();
...
// 			G1SemeruCollectedHeap::fill_with_objects(bottom_address, fill_size);
// 			increase_used(fill_size * HeapWordSize);
// 		}
// 	}
// }

inline HeapWord* G1SemeruCollectedHeap::attempt_allocation(size_t min_word_size,
...
// void G1SemeruCollectedHeap::dealloc_archive_regions(MemRegion* ranges, size_t count, bool is_open) {
// 	assert(!is_init_completed(), "Expect to be called at JVM init time");
// 	assert(ranges != NULL, "MemRegion array NULL");
// 	assert(count != 0, "No MemRegions provided");
// 	MemRegion reserved = _hrm->reserved();
...
// oop G1SemeruCollectedHeap::materialize_archived_object(oop obj) {
...
HeapWord* G1SemeruCollectedHeap::attempt_allocation_humongous(size_t word_size) {
	ResourceMark rm; // For retrieving the thread names in log messages.

	//debug
	tty->print("%s, waiting to be completed. \n", __func__);
...
//  * 
//  */
// HeapWord* G1SemeruCollectedHeap::attempt_allocation_at_safepoint(size_t word_size,
...
// void G1SemeruCollectedHeap::print_hrm_post_compaction() {
...
// void G1SemeruCollectedHeap::abort_concurrent_cycle() {
...
// void G1SemeruCollectedHeap::prepare_heap_for_full_collection() {
...
// void G1SemeruCollectedHeap::verify_before_full_collection(bool explicit_gc) {
...
// void G1SemeruCollectedHeap::prepare_heap_for_mutators() {
...
// void G1SemeruCollectedHeap::abort_refinement() {
...
// void G1SemeruCollectedHeap::verify_after_full_collection() {
...
// void G1SemeruCollectedHeap::print_heap_after_full_collection(G1HeapTransition* heap_transition) {
 ...
 * 
 */
bool G1SemeruCollectedHeap::do_full_collection(bool explicit_gc,
 ...
 * 
 */
void G1SemeruCollectedHeap::do_full_collection(bool clear_all_soft_refs) {
...
// HeapWord* G1SemeruCollectedHeap::satisfy_failed_allocation(size_t word_size,
// 																										 bool* succeeded) {
// 	assert_at_safepoint_on_vm_thread();
...
// HeapWord* G1SemeruCollectedHeap::expand_and_allocate(size_t word_size) {
// 	assert_at_safepoint_on_vm_thread();
...
// jint G1SemeruCollectedHeap::initialize_young_gen_sampling_thread() {
...
void G1SemeruCollectedHeap::safepoint_synchronize_end() {
...
void G1SemeruCollectedHeap::ref_processing_init() {
...
SoftRefPolicy* G1SemeruCollectedHeap::soft_ref_policy() {
...
//  * 
//  */
// void G1SemeruCollectedHeap::iterate_dirty_card_closure(CardTableEntryClosure* cl, uint worker_i) {
// 	DirtyCardQueueSet& dcqs = G1BarrierSet::dirty_card_queue_set();
...
size_t G1SemeruCollectedHeap::used() const {
...
size_t G1SemeruCollectedHeap::used_unlocked() const {
...
// size_t G1SemeruCollectedHeap::recalculate_used() const {
// 	SumUsedClosure blk;
// 	heap_region_iterate(&blk);
// 	return blk.result();
// }

// bool  G1SemeruCollectedHeap::is_user_requested_concurrent_full_gc(GCCause::Cause cause) {
// 	switch (cause) {
...
// bool G1SemeruCollectedHeap::should_do_concurrent_full_gc(GCCause::Cause cause) {
// 	switch (cause) {
...
// bool G1SemeruCollectedHeap::should_upgrade_to_full_gc(GCCause::Cause cause) {
...
// bool G1SemeruCollectedHeap::try_collect(GCCause::Cause cause, bool retry_on_gc_failure) {
// 	assert_heap_not_locked();
...
bool G1SemeruCollectedHeap::is_in(const void* p) const {
...
void G1SemeruCollectedHeap::object_iterate(ObjectClosure* cl) {
	  SemeruIterateObjectClosureRegionClosure blk(cl);
	heap_region_iterate(&blk);
}
...
bool G1SemeruCollectedHeap::supports_tlab_allocation() const {
	return true;
}
...
size_t G1SemeruCollectedHeap::max_tlab_size() const {
	return align_down(_humongous_object_threshold_in_words, MinObjAlignment);
}

// size_t G1SemeruCollectedHeap::unsafe_max_tlab_alloc(Thread* ignored) const {
...
void G1SemeruCollectedHeap::deduplicate_string(oop str) {
...
void G1SemeruCollectedHeap::prepare_for_verify() {
 	_verifier->prepare_for_verify();
}

void G1SemeruCollectedHeap::verify(VerifyOption vo) {
	_verifier->verify(vo);
}

bool G1SemeruCollectedHeap::supports_concurrent_phase_control() const {
 	return true;
}
...
void G1SemeruCollectedHeap::print_on(outputStream* st) const {
...
void G1SemeruCollectedHeap::print_regions_on(outputStream* st) const {
	st->print_cr("Heap Regions: E=young(eden), S=young(survivor), O=old, "
							 "HS=humongous(starts), HC=humongous(continues), "
							 "CS=collection set, F=free, A=archive, "
							 "TAMS=top-at-mark-start (previous, next)");
	SemeruPrintRegionClosure blk(st);
	heap_region_iterate(&blk);
}

void G1SemeruCollectedHeap::print_extended_on(outputStream* st) const {
	print_on(st);
...
void G1SemeruCollectedHeap::print_tracing_info() const {
...
public:
	...
	SemeruPrintRSetsClosure(const char* msg) : _msg(msg), _occupied_sum(0) {
		tty->cr();
		tty->print_cr("========================================");
		tty->print_cr("%s", msg);
		tty->cr();
...
// void G1SemeruCollectedHeap::print_cset_rsets() {
// 	PrintRSetsClosure cl("Printing CSet RSets");
// 	collection_set_iterate(&cl);
// }

void G1SemeruCollectedHeap::print_all_rsets() {
	SemeruPrintRSetsClosure cl("Printing All RSets");
	heap_region_iterate(&cl);
}
#endif // PRODUCT

G1HeapSummary G1SemeruCollectedHeap::create_g1_heap_summary() {
...
// G1EvacSummary G1SemeruCollectedHeap::create_g1_evac_summary(G1EvacStats* stats) {
...
void G1SemeruCollectedHeap::trace_heap(GCWhen::Type when, const GCTracer* gc_tracer) {
...
// void G1SemeruCollectedHeap::gc_prologue(bool full) {
...
// void G1SemeruCollectedHeap::gc_epilogue(bool full) {
// 	// Update common counters.
// 	if (full) {
...
HeapWord* G1SemeruCollectedHeap::do_collection_pause(size_t word_size,
																							 uint gc_count_before,
																							 bool* succeeded,
...
// uint G1SemeruCollectedHeap::num_task_queues() const {
// 	return _task_queues->size();
// }

// #if TASKQUEUE_STATS
// void G1SemeruCollectedHeap::print_taskqueue_stats_hdr(outputStream* const st) {
// 	st->print_raw_cr("GC Task Stats");
// 	st->print_raw("thr "); TaskQueueStats::print_header(1, st); st->cr();
// 	st->print_raw("--- "); TaskQueueStats::print_header(2, st); st->cr();
// }

// void G1SemeruCollectedHeap::print_taskqueue_stats() const {
...
// void G1SemeruCollectedHeap::reset_taskqueue_stats() {
// 	const uint n = num_task_queues();
// 	for (uint i = 0; i < n; ++i) {
...
// void G1SemeruCollectedHeap::wait_for_root_region_scanning() {
...
// void G1SemeruCollectedHeap::start_new_collection_set() {
...
//  */
// bool
// G1SemeruCollectedHeap::do_collection_pause_at_safepoint(double target_pause_time_ms) {
// 	assert_at_safepoint_on_vm_thread();
...
// 			// Please see comment in G1SemeruCollectedHeap.hpp and
// 			// G1SemeruCollectedHeap::ref_processing_init() to see how
...
// 				//  class G1SemeruCollectedHeap::G1SurvivorRegions _survivor
// 				//
...
// void G1SemeruCollectedHeap::restore_after_evac_failure() {
...
// void G1SemeruCollectedHeap::preserve_mark_during_evac_failure(uint worker_id, oop obj, markOop m) {
...
// bool G1SemeruParEvacuateFollowersClosure::offer_termination() {
...
// void G1SemeruParEvacuateFollowersClosure::do_void() {
// 	EventGCPhaseParallel event;
// 	G1ParScanThreadState* const pss = par_scan_state();
// 	pss->trim_queue();
...
// public:
// 	G1ParTask(G1SemeruCollectedHeap* g1h, G1ParScanThreadStateSet* per_thread_states, RefToScanQueueSet *task_queues, G1RootProcessor* root_processor, uint n_workers)
...
// 			{
// 				double start = os::elapsedTime();
// 				G1SemeruParEvacuateFollowersClosure evac(_g1h, pss, _queues, _terminator.terminator(), G1GCPhaseTimes::ObjCopy);
...
// void G1SemeruCollectedHeap::print_termination_stats_hdr() {
...
// void G1SemeruCollectedHeap::print_termination_stats(uint worker_id,
// 																							double elapsed_ms,
...
// 	G1SemeruCollectedHeap* _g1h;
//  public:
// 	G1RedirtyLoggedCardsTask(DirtyCardQueueSet* queue, G1SemeruCollectedHeap* g1h) : AbstractGangTask("Redirty Cards"),
...
// void G1SemeruCollectedHeap::redirty_logged_cards() {
...
bool G1SemeruSTWIsAliveClosure::do_object_b(oop p) {
	// An object is reachable if it is outside the collection set,
	// or is inside and copied.
	return !_g1h->is_in_cset(p) || p->is_forwarded();
}

bool G1SemeruSTWSubjectToDiscoveryClosure::do_object_b(oop obj) {
...
// 	G1SemeruCollectedHeap*_g1h;
// public:
// 	G1KeepAliveClosure(G1SemeruCollectedHeap* g1h) :_g1h(g1h) {}
...
// public:
// 	G1CopyingKeepAliveClosure(G1SemeruCollectedHeap* g1h,
...
// public:
// 	G1STWDrainQueueClosure(G1SemeruCollectedHeap* g1h, G1ParScanThreadState* pss) :
// 		_g1h(g1h),
// 		_par_scan_state(pss)
// 	{ }
...
// public:
// 	G1STWRefProcTaskExecutor(G1SemeruCollectedHeap* g1h,
...
// 		G1SemeruSTWIsAliveClosure is_alive(_g1h);
...
// 		// Complete GC closure
// 		G1SemeruParEvacuateFollowersClosure drain_queue(_g1h, pss, _task_queues, _terminator, G1GCPhaseTimes::ObjCopy);
...
// void G1SemeruCollectedHeap::process_discovered_references(G1ParScanThreadStateSet* per_thread_states) {
...
// 	G1SemeruSTWIsAliveClosure is_alive(this);
...
// void G1SemeruCollectedHeap::make_pending_list_reachable() {
// 	if (collector_state()->in_initial_mark_gc()) {
...
// void G1SemeruCollectedHeap::merge_per_thread_state_info(G1ParScanThreadStateSet* per_thread_states) {
...
//  * G1ThreadLocalData->_dirty_card_queue  to G1BarrierSet->_dirty_card_queue_set
//  */
// void G1SemeruCollectedHeap::pre_evacuate_collection_set() {
...
//  * 
//  */
// void G1SemeruCollectedHeap::evacuate_collection_set(G1ParScanThreadStateSet* per_thread_states) {
...
// 		Ticks start = Ticks::now();
// 		G1SemeruParEvacuateFollowersClosure cl(_g1h, pss, _queues, &_terminator, G1GCPhaseTimes::OptObjCopy);
// 		cl.do_void();
...
//  public:
// 	G1EvacuateOptionalRegionTask(G1SemeruCollectedHeap* g1h,
// 															 G1ParScanThreadStateSet* per_thread_states,
// 															 G1OptionalCSet* cset,
...
// void G1SemeruCollectedHeap::evacuate_optional_regions(G1ParScanThreadStateSet* per_thread_states, G1OptionalCSet* ocset) {
...
// void G1SemeruCollectedHeap::evacuate_optional_collection_set(G1ParScanThreadStateSet* per_thread_states) {
...
// void G1SemeruCollectedHeap::post_evacuate_collection_set(EvacuationInfo& evacuation_info, G1ParScanThreadStateSet* per_thread_states) {
...
// void G1SemeruCollectedHeap::record_obj_copy_mem_stats() {
...
// 		G1Policy* policy = G1SemeruCollectedHeap::heap()->g1_policy();
...
// 	virtual void work(uint worker_id) {
// 		G1GCPhaseTimes* timer = G1SemeruCollectedHeap::heap()->g1_policy()->phase_times();
...
// void G1SemeruCollectedHeap::free_collection_set(G1CollectionSet* collection_set, EvacuationInfo& evacuation_info, const size_t* surviving_young_words) {
// 	_eden.clear();
...
// void G1SemeruCollectedHeap::eagerly_reclaim_humongous_regions() {
// 	assert_at_safepoint_on_vm_thread();
...
// void G1SemeruCollectedHeap::abandon_collection_set(G1CollectionSet* collection_set) {
...
// bool G1SemeruCollectedHeap::check_young_list_empty() {
...
// void G1SemeruCollectedHeap::tear_down_region_sets(bool free_list_only) {
// 	assert_at_safepoint_on_vm_thread();
...
void G1SemeruCollectedHeap::increase_used(size_t bytes) {
	_summary_bytes_used += bytes;
}

void G1SemeruCollectedHeap::decrease_used(size_t bytes) {
...
void G1SemeruCollectedHeap::set_used(size_t bytes) {
	_summary_bytes_used = bytes;
}
...
// void G1SemeruCollectedHeap::rebuild_region_sets(bool free_list_only) {
// 	assert_at_safepoint_on_vm_thread();
...
// public:
// 	RegisterNMethodOopClosure(G1SemeruCollectedHeap* g1h, nmethod* nm) :
// 		_g1h(g1h), _nm(nm) {}
...
// public:
// 	UnregisterNMethodOopClosure(G1SemeruCollectedHeap* g1h, nmethod* nm) :
// 		_g1h(g1h), _nm(nm) {}
...
void G1SemeruCollectedHeap::register_nmethod(nmethod* nm) {
// 	guarantee(nm != NULL, "sanity");
// 	RegisterNMethodOopClosure reg_cl(this, nm);
// 	nm->oops_do(&reg_cl);
}

void G1SemeruCollectedHeap::unregister_nmethod(nmethod* nm) {
// 	guarantee(nm != NULL, "sanity");
// 	UnregisterNMethodOopClosure reg_cl(this, nm);
// 	nm->oops_do(&reg_cl, true); 
}

// void G1SemeruCollectedHeap::purge_code_root_memory() {
...
// public:
// 	RebuildStrongCodeRootClosure(G1SemeruCollectedHeap* g1h) :
// 		_g1h(g1h) {}
...
// void G1SemeruCollectedHeap::rebuild_strong_code_roots() {
...
MemoryUsage G1SemeruCollectedHeap::memory_usage() {
	return _g1mm->memory_usage();
}

GrowableArray<GCMemoryManager*> G1SemeruCollectedHeap::memory_managers() {
	return _g1mm->memory_managers();
}

GrowableArray<MemoryPool*> G1SemeruCollectedHeap::memory_pools() {
